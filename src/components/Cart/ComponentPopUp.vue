    ...
    <div class="background">
        ...
        <div class="containerPopup">
                ...
                <div class="form-row">
                    <div class="input-field">
                        ...
                        <div class="inputContainer">
                            ...
                            <input type="text" v-model="formData.nome" @input="input" name="txtNome" id="txtNome"
            ...
            <div class="containerInfo">
                ...
                <div class="form-row">
                    <div class="input-field">
                        ...
                        <div class="inputContainer">
                            <input type="number" name="numTel" v-model="formData.endereco.numero" min="0"
                                @input="input" />
                        </div>
                    </div>
                    <div class="input-field">
            ...
            <div class="containerButtons">
                <Button v-show="next" @click="finish" />
                <ButtonBack />
            </div>
        </div>
    </div>
